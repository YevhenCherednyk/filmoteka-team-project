 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function zt(t,e,n=!1){const i="signIn",r=await Mt(t,i,e),o=await Ot._fromIdTokenResponse(t,i,r);return n||await t._updateCurrentUser(o.user),o}async function Ut(t,e){return zt(ft(t),e)}async function jt(t,e,n){const i=ft(t),r=await Rt(i,{returnSecureToken:!0,email:e,password:n}),o=await Ot._fromIdTokenResponse(i,"signIn",r);return await i._updateCurrentUser(o.user),o}function Ft(t,e,n){return Ut((0,i.getModularInstance)(t),It.credential(e,n))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
